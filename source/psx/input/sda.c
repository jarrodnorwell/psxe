...
uint32_t psxi_sda_read(void *udata)
{
    ...
    switch (sda->state)
    {
    case SDA_STATE_TX_HIZ:
        sda->tx_data = 0xff;
        break;
    case SDA_STATE_TX_IDL:
    ...
    case SDA_STATE_TX_ADC0:
        sda->tx_data = sda->adc0;
        break;
    case SDA_STATE_TX_ADC1:
        sda->tx_data = sda->adc1;
        break;
    case SDA_STATE_TX_ADC2:
        sda->tx_data = sda->adc2;
        break;
...
void psxi_sda_on_analog_change(void *udata, uint32_t axis, uint16_t data)
{
    ...
    switch (axis)
    {
    case PSXI_AX_SDA_RIGHT_HORZ:
        sda->adc0 = data;
        break;
    case PSXI_AX_SDA_RIGHT_VERT:
        sda->adc1 = data;
        break;
    case PSXI_AX_SDA_LEFT_HORZ:
        sda->adc2 = data;
        break;
    case PSXI_AX_SDA_LEFT_VERT:
        sda->adc3 = data;
        break;
    }
}
