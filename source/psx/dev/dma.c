...
uint32_t psx_dma_read32(psx_dma_t *dma, uint32_t offset)
{
    ...
    else
    {
        ...
        {
        case 0x70:
            log_error("DMA control read %08x", dma->dpcr);
            return dma->dpcr;
        case 0x74:
            log_error("DMA irqc    read %08x", dma->dicr);
            return dma->dicr;
...
uint8_t psx_dma_read8(psx_dma_t *dma, uint32_t offset)
{
    ...
    case 0x70:
        return dma->dpcr;
    case 0x74:
        return (dma->dicr >> 0) & 0xff;
    case 0x75:
        return (dma->dicr >> 8) & 0xff;
    case 0x76:
        return (dma->dicr >> 16) & 0xff;
    case 0x77:
        return (dma->dicr >> 24) & 0xff;
...
void psx_dma_write32(psx_dma_t *dma, uint32_t offset, uint32_t value)
{
    ...
    else
    {
        ...
        {
        case 0x70:
            log_error("DMA control write %08x", value);
            dma->dpcr = value;
            break;
        case 0x74:
        {
...
void psx_dma_write16(psx_dma_t *dma, uint32_t offset, uint16_t value)
{
    ...
    {
    case 0x74:
        dma_write_dicr(dma, ((uint32_t)value) << 0);
    case 0x76:
        dma_write_dicr(dma, ((uint32_t)value) << 16);
    default:
    {
...
void psx_dma_write8(psx_dma_t *dma, uint32_t offset, uint8_t value)
{
    ...
    case 0x74:
        ...
        break;
    case 0x75:
        dma_write_dicr(dma, ((uint32_t)value) << 8);
        break;
    case 0x76:
        dma_write_dicr(dma, ((uint32_t)value) << 16);
        break;
    case 0x77:
        dma_write_dicr(dma, ((uint32_t)value) << 24);
        break;
    default:
    {
